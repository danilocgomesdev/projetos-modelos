...
public class GetinServicesTokenCacheService extends TokenCacheService {
    ...
    public GetinServicesTokenCacheService(
            ...
            // @ConfigProperty(name = "-webservices-v2.keycloak-getin-service-api.username") String username,
            // @ConfigProperty(name = "-webservices-v2.keycloak-getin-service-api.password") String password,
            // @ConfigProperty(name = "-webservices-v2.keycloak-getin-service-api.client_id") String clientId
    ) {
