...
@ApplicationScoped
public class ConciliacaoPagamentoBC extends ConciliacaoAbstract {
    ...
    protected void registrarConciliacao(ArquivoRetornoDTO arquivoRetornoDTO) {
        ...
        if (!"04".equals(arquivoRetornoDTO.getCabecalho().getOpcaoExtrato())) {
        ...
        for (TransacaoCieloDTO dto: transacoes) {
            conciliadorService.registrarConciliacaoPagamento(dto);
        }
    }
