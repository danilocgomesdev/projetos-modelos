...
@Entity
@Table(name = "CR5_DETALHE_COMPROVANTE_PAGAMENTO")
public class DetalheComprovantePagamento extends PanacheEntityBase {
    ...
    @Column(name = "DCP_CODIGO_AUTORIZACAO")
    private String codigoAutorizacao;

    @Column(name = "DCP_CODIGO_PEDIDO")
    private String codigoPedido;

    @Column(name = "DCP_DATA_VENDA")
    private Date dataVenda;

    @Column(name = "DCP_EMITIDO_EXTERIOR")
    private String emitidoExterior;

    @Column(name = "DCP_ESTABELECIMENTO_SUBMISSOR")
    private String estabelecimentoSubmissor;

    @Column(name = "DCP_HORA_TRANSACAO")
    private String horaTransacao;

    @Column(name = "DCP_IDENTIFICADOR_TAXA_EMBARQUE")
    private String identificadorTaxaEmbarque;

    @Column(name = "DCP_INDICADOR_CIELO_PROMOCAO")
    private String indicadorCieloPromocao;

    @Column(name = "DCP_MOTIVO_REJEICAO")
    private String motivoRejeicao;

    @Column(name = "DCP_NUM_CARTAO")
    private String numeroCartao;

    @Column(name = "DCP_NUMERO_NSU")
    private String numeroNSU;

    @Column(name = "DCP_NUM_NOTA_FISCAL_POS")
    private String numeroNotaFiscalPOS;

    @Column(name = "DCP_NUM_PARCELA")
    private String numeroParcela;

    @Column(name = "DCP_NUM_RESUMO_OPERACAO")
    private String numeroResumoOperacao;

    @Column(name = "DCP_NUM_TERMINAL")
    private String numeroTerminal;

    @Column(name = "DCP_NUMERO_UNICO_RO")
    private String numeroUnicoRO;

    @Column(name = "DCP_NUM_UNICO_TRANSACAO")
    private String numeroUnicoTransacao;

    @Column(name = "DCP_QTDE_DIGITOS_CARTAO")
    private String qtdeDigitosCartao;

    @Column(name = "DCP_QTDE_PARCELAS")
    ...
    //Crédito: +
    //Débito: -
    @Column(name = "DCP_TIPO_OPERACAO")
    private String tipoOperacao;

    @Column(name = "DCP_VALOR_COMPLEMENTAR")
    private BigDecimal valorComplementar;

    @Column(name = "DCP_VALOR_PROXIMA_PARCELA")
    private BigDecimal valorProximaParcela;

    @Column(name = "DCP_VALOR_TOTAL_VENDA")
    private BigDecimal valorTotalVenda;

    @Column(name = "DCP_VALOR_VENDA")
    ...
    public DetalheComprovantePagamento(){
    }
    ...
    public String toString() {
        return "DetalheComprovantePagamento{" +
                "id=" + id +
