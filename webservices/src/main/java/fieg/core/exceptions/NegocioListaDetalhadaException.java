...
public class NegocioListaDetalhadaException extends ApplicationExceptionBase {
    ...
    public NegocioListaDetalhadaException() {
        super("Um ou mais erros encontrados. Ver lista de detalhes (listaDetalhes).", CodigoErroCr5.REGRA_DE_NEGOCIO);
    }
    ...
    public void addToJsonResponse(ObjectNode json) {
        ...
        for (NegocioListaDetalhadaException.DadoErro dadoErro : getErroList()) {
            jsonArray.addObject()
