...
public class GetinServicesTokenCacheService extends TokenCacheService {
    ...
    public GetinServicesTokenCacheService(
            ...
            @ConfigProperty(name = "auth-middleware.keycloak-getin-service-api.username") String username,
            @ConfigProperty(name = "auth-middleware.keycloak-getin-service-api.password") String password,
            @ConfigProperty(name = "auth-middleware.keycloak-getin-service-api.client_id") String clientId
    ) {
